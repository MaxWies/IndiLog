...
constexpr int kAggregatorIngressTypeId          = 0x16 << 16;
constexpr int kAggregatorEgressHubTypeId        = 0x17 << 16;
...
constexpr int kRegistrationTimerId          = kTimerTypeId + 4;
constexpr int kGracePeriodTimerId           = kTimerTypeId + 5;
